...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Valor.genero'
        db.add_column(u'home_valor', 'genero',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=1, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Valor.genero'
        db.delete_column(u'home_valor', 'genero')
